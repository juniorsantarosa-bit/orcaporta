...
export const mockSheetLayouts: NestingSheet[] = [
  {
    ...
    efficiency: 87.3,
    pieces: [
      { pieceId: 1, x: 5, y: 5, width: 2399, height: 564, rotated: false, label: "0", descricao: "!DIV_INT", furos: holesDIVINT, bordaSup: false, bordaInf: false, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
      { pieceId: 3, x: 5, y: 573, width: 2500, height: 580, rotated: false, label: "1", descricao: "!LAT_ESQ", furos: holesLATESQ, bordaSup: true, bordaInf: false, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
      { pieceId: 4, x: 5, y: 1157, width: 2500, height: 580, rotated: false, label: "2", descricao: "!LAT_DIR", furos: holesLATDIR, bordaSup: true, bordaInf: false, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
      { pieceId: 10, x: 2509, y: 5, width: 235, height: 735, rotated: true, label: "3", descricao: "!FUNDO", furos: noHoles, bordaSup: false, bordaInf: false, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
    ],
  },
  {
    id: 2,
    ...
    efficiency: 72.1,
    pieces: [
      { pieceId: 2, x: 5, y: 5, width: 1469, height: 580, rotated: false, label: "4", descricao: "!BASE_SUP", furos: holesBASESUP, bordaSup: false, bordaInf: false, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
      { pieceId: 5, x: 1478, y: 5, width: 1269, height: 564, rotated: true, label: "5", descricao: "!PRAT_INF", furos: noHoles, bordaSup: false, bordaInf: true, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
      { pieceId: 6, x: 5, y: 589, width: 1469, height: 580, rotated: false, label: "6", descricao: "!BASE_INF", furos: noHoles, bordaSup: false, bordaInf: true, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
      { pieceId: 7, x: 1478, y: 589, width: 717.5, height: 564, rotated: false, label: "7", descricao: "!PRAT_01", furos: noHoles, bordaSup: false, bordaInf: true, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
      { pieceId: 8, x: 5, y: 1173, width: 760, height: 497, rotated: false, label: "8", descricao: "!PORTA_ESQ", furos: holesDobradica, bordaSup: true, bordaInf: true, bordaEsq: true, bordaDir: true, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
      { pieceId: 9, x: 769, y: 1173, width: 760, height: 497, rotated: false, label: "9", descricao: "!PORTA_DIR", furos: holesDobradica, bordaSup: true, bordaInf: true, bordaEsq: true, bordaDir: true, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
      { pieceId: 11, x: 1533, y: 1173, width: 717.5, height: 564, rotated: false, label: "10", descricao: "!DIV_INT_2", furos: holesDIVINT.slice(0, 4), bordaSup: false, bordaInf: false, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
      { pieceId: 12, x: 2254, y: 589, width: 490, height: 580, rotated: true, label: "11", descricao: "!TAMP_SUP", furos: noHoles, bordaSup: false, bordaInf: false, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", espessura: 15 },
    ],
  },
];

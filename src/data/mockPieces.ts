...
export const mockSheetLayouts: NestingSheet[] = [
  ...
  },
  {
    ...
    efficiency: 72.1,
    pieces: [
      { pieceId: 2, x: 5, y: 5, width: 580, height: 1469, rotated: true, label: "4", descricao: "!BASE_SUP", furos: holesBASESUP, bordaSup: false, bordaInf: false, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", usinagens: [], espessura: 15 },
      { pieceId: 5, x: 5, y: 1478, width: 564, height: 1269, rotated: false, label: "5", descricao: "!PRAT_INF", furos: noHoles, bordaSup: false, bordaInf: true, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", usinagens: [], espessura: 15 },
      { pieceId: 6, x: 589, y: 5, width: 580, height: 1469, rotated: true, label: "6", descricao: "!BASE_INF", furos: noHoles, bordaSup: false, bordaInf: true, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", usinagens: [], espessura: 15 },
      { pieceId: 7, x: 589, y: 1478, width: 564, height: 717.5, rotated: true, label: "7", descricao: "!PRAT_01", furos: noHoles, bordaSup: false, bordaInf: true, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", usinagens: [], espessura: 15 },
      { pieceId: 8, x: 1173, y: 5, width: 497, height: 760, rotated: true, label: "8", descricao: "!PORTA_ESQ", furos: holesDobradica, bordaSup: true, bordaInf: true, bordaEsq: true, bordaDir: true, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", usinagens: [], espessura: 15 },
      { pieceId: 9, x: 1173, y: 769, width: 497, height: 760, rotated: true, label: "9", descricao: "!PORTA_DIR", furos: holesDobradica, bordaSup: true, bordaInf: true, bordaEsq: true, bordaDir: true, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", usinagens: [], espessura: 15 },
      { pieceId: 11, x: 1173, y: 1533, width: 564, height: 717.5, rotated: true, label: "10", descricao: "!DIV_INT_2", furos: holesDIVINT.slice(0, 4), bordaSup: false, bordaInf: false, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", usinagens: [], espessura: 15 },
      { pieceId: 12, x: 589, y: 2254, width: 580, height: 490, rotated: false, label: "11", descricao: "!TAMP_SUP", furos: noHoles, bordaSup: false, bordaInf: false, bordaEsq: false, bordaDir: false, cliente: "Julia", ambiente: "Quarto", moduloDesc: "ARM_01", usinagens: [], espessura: 15 },
    ],
  },
];

    ...
    <div className="flex h-full bg-background">
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 overflow-auto p-4 flex items-center justify-center">
          {viewMode === "2d" && (
            <SheetView2D ref={view2DRef} layout={layouts[selectedSheetIdx]} selectedPieceId={selectedPieceId} />
          )}
          {viewMode === "3d" && (
      ...
      <div className="w-9 border-l border-border bg-card flex flex-col items-center py-2 gap-0.5">
        ...
        <ViewToolButton icon={Move} label="Mover" onClick={() => {}} active={viewMode === "2d"} />
        <ViewToolButton icon={RotateCw} label="Orbit" onClick={() => setViewMode("3d")} active={viewMode === "3d"} />
        ...
        <ViewToolButton icon={Layers} label="Camadas" onClick={() => setViewMode("report")} />
        <Separator className="my-1 w-5" />
        <ViewToolButton icon={Printer} label="Imprimir" onClick={handlePrint} />
